/* 
   ...
   Don't worry Fabrice, i don't think to use this beautiful code for commercial purpose!  
*/
"use strict";
function Term(aa, ba, ca, da, ma) {
    this.w = aa;
    this.h = ba;
    this.cur_h = ba;
    this.tot_h = 1000;
    ...
    this.key_rep_str = "";
    this.elem=document.getElementById(da);
    this.command='';
    this.history=[];
    this.prompt=ma+'>';
}
Term.prototype.open = function() {
    ...
    //this.elem.addEventListener("keydown", this.keyDownHandler.bind(this), true);
    //this.elem.addEventListener("keypress", this.keyPressHandler.bind(this), true);
    ea = this;
...
Term.prototype.keyDownHandler = function(ya) {
    ...
    // DEL
    case 8:
        pa = String.fromCharCode(8)+" "+String.fromCharCode(8);
        break;
    // TAB
    case 9: 
        pa = "\t";
